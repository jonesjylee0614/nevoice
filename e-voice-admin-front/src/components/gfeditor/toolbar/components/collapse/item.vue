<template>
  <APopover
    ...
    :content-class="prompt ? '' : 'prompt-popover-hide'"
    :arrow-class="prompt ? '' : 'prompt-popover-hide'"
  >
    <template #content>
      <component :is="prompt" />
    </template>
    <div
      class="toolbar-collapse-item"
      :class="[{ 'toolbar-collapse-item-active': active }, { 'toolbar-collapse-item-disabled': disabled }, className]"
