<template>
  <div class="colorpicker-board" @mousedown="triggerMouseDown">
    <div class="colorpicker-default" @click="triggerSelect(defaultColor, $event)">
      <AmColorPickerItem :engine="engine" :color="defaultColor" :active-colors="[]" :on-select="triggerSelect" />
