...
import type { EngineInterface, Placement } from '@/components/gfeditor/emain';

// 命令
export type Command = { name: string; args: Array<any> } | Array<any> | undefined;
// 按钮
export const buttonProps = {
  ...
  icon: String,
  content: [String, Function] as PropType<string | ((engine?: EngineInterface) => string) | VNode>,
  title: String,
  ...
  onClick: Function as PropType<(event: MouseEvent, engine?: EngineInterface) => void | boolean>,
  onMouseDown: Function as PropType<(event: MouseEvent, engine?: EngineInterface) => void | boolean>,
  onMouseEnter: Function as PropType<(event: MouseEvent, engine?: EngineInterface) => void | boolean>,
  onMouseLevel: Function as PropType<(event: MouseEvent, engine?: EngineInterface) => void | boolean>
};
...
export const dropdownListProps = {
  engine: Object as PropType<EngineInterface>,
  name: {
    type: String,
    required: true
  } as const,
  ...
  className: String,
  onSelect: Function as PropType<(event: MouseEvent, key: string, engine?: EngineInterface) => void | boolean>,
  hasDot: {
    type: [Boolean, undefined] as PropType<boolean | undefined>,
    default: undefined
  }
...
export const dropdownProps = {
  ...
  icon: String,
  placement: String as PropType<Placement>,
  content: [String, Function] as PropType<string | ((engine?: EngineInterface) => string)>,
  title: String,
  disabled: {
    type: [Boolean, undefined] as PropType<boolean | undefined>,
    default: undefined
...
export const colorProps = {
  ...
  content: {
    type: [String, Function] as PropType<string | ((color: string, stroke: string, disabled?: boolean) => string)>,
    required: true
  } as const,
  buttonTitle: String,
...
export const collapseItemProps = {
  ...
  disabled: buttonProps.disabled,
  prompt: [String, Function, Object] as PropType<string | (() => string) | VNode>,
  command: buttonProps.command,
  autoExecute: buttonProps.autoExecute,
  className: buttonProps.className,
  placement: buttonProps.placement,
  onClick: Function as PropType<(event: MouseEvent, name: string, engine?: EngineInterface) => boolean | void>,
  onMouseDown: Function as PropType<(event: MouseEvent, engine?: EngineInterface) => void>
};
...
export const groupProps = {
  ...
  items: {
    type: Array as PropType<Array<GroupButtonProps | GroupDropdownProps | GroupColorProps | ToolbarCollapseGroupProps>>,
    default: []
  },
  popup: {
    type: [Boolean, undefined] as PropType<boolean | undefined>,
