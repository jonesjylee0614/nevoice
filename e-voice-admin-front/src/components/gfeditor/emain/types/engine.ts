...
import type { EventListener, NodeInterface, Selector } from './node';
import type { ChangeInterface } from './change';
import type { OTInterface } from './ot';
import type { SchemaInterface } from './schema';
import type { HistoryInterface } from './history';
import type { CardInterface } from './card';
import type { ClipboardData } from './clipboard';
import type { TypingInterface } from './typing';
import type { RangeInterface } from './range';
import type { EditorInterface, EditorOptions } from './editor';
...
export interface EngineInterface<T extends EngineOptions = EngineOptions> extends EditorInterface<T> {
  ...
  /**
   * 异步获取编辑器值，将等候插件处理完成后再获取值 比如插件上传等待中，将等待上传完成后再获取值
   *
  ...
  getValueAsync(
    ...
    callback?: (name: string, card?: CardInterface, ...args: any) => boolean | number | void
  ): Promise<string>;
  /** 获取编辑器的html */
  getHtml(): string;
  /**
   ...
   * @param callback 异步渲染卡片后的回调
   */
  setJsonValue(value: Array<any>, callback?: (count: number) => void): EngineInterface;
  /** 获取JSON格式的值 */
   ...
   * @param rewrite 是否重写
   */
  on<R = any, F extends EventListener<R> = EventListener<R>>(eventType: string, listener: F, rewrite?: boolean): void;
  /**
   ...
   * @param rewrite
   */
  on(eventType: 'keydown:all', listener: (event: KeyboardEvent) => boolean | void, rewrite?: boolean): void;
  /**
   * 卡片最小化时触发
   *
   * @param eventType
   ...
   * @param rewrite
   */
  on(eventType: 'card:minimize', listener: (card: CardInterface) => void, rewrite?: boolean): void;
  /**
   * 卡片最大化时触发
   *
   * @param eventType
   ...
   * @param rewrite
   */
  on(eventType: 'card:maximize', listener: (card: CardInterface) => void, rewrite?: boolean): void;
  /**
   * 解析DOM节点，生成符合标准的 XML 代码之前触发
   *
   * @param root DOM节点
   */
  on(eventType: 'parse:value-before', listener: (root: NodeInterface) => void, rewrite?: boolean): void;
  /**
   ...
   * @param value xml代码
   */
  on(eventType: 'parse:value-after', listener: (value: Array<string>) => void, rewrite?: boolean): void;
  /**
   * 转换为HTML代码之前触发
   *
   * @param root 需要转换的根节点
   */
  on(eventType: 'parse:html-before', listener: (root: NodeInterface) => void, rewrite?: boolean): void;
  /**
   * 转换为HTML代码
   *
   * @param root 需要转换的根节点
   */
  on(eventType: 'parse:html', listener: (root: NodeInterface) => void, rewrite?: boolean): void;
  /**
   * 转换为HTML代码之后触发
   *
   * @param root 需要转换的根节点
   */
  on(eventType: 'parse:html-after', listener: (root: NodeInterface) => void, rewrite?: boolean): void;
  /**
  ...
  on(
    ...
    listener: (data: ClipboardData & { isPasteText: boolean }, source: string) => boolean | void,
    rewrite?: boolean
  ): void;
  /**
   ...
   */
  on(eventType: 'paste:schema', listener: (schema: SchemaInterface) => void, rewrite?: boolean): void;
  /**
   * 解析粘贴数据，还未生成符合编辑器数据的片段之前触发
   *
   * @param root 粘贴的DOM节点
   */
  on(eventType: 'paste:origin', listener: (root: NodeInterface) => void, rewrite?: boolean): void;
  /**
   * 解析粘贴数据，生成符合编辑器数据的片段之后扁平化阶段触发
   *
   * @param node 粘贴片段遍历的子节点
   */
  on(eventType: 'paste:each', listener: (root: NodeInterface) => void, rewrite?: boolean): void;
  /**
   * 解析粘贴数据，生成符合编辑器数据的片段之后扁平化阶段触发
   *
   * @param node 所有粘贴片段遍历后的根节点
   */
  on(eventType: 'paste:each-after', listener: (root: NodeInterface) => void, rewrite?: boolean): void;
  /**
   * 生成粘贴数据DOM片段后，还未写入到编辑器之前触发
   *
   * @param fragment 粘贴的片段
   */
  on(eventType: 'paste:before', listener: (fragment: DocumentFragment) => void, rewrite?: boolean): void;
  /**
   * 插入当前粘贴的片段后触发，此时还未渲染卡片
   *
   * @param range 当前插入后的光标实例
   */
  on(eventType: 'paste:insert', listener: (range: RangeInterface) => void, rewrite?: boolean): void;
  /** 粘贴完成后触发 */
   ...
   * @param node 当前遍历的子节点
   */
  on(eventType: 'copy', listener: (root: NodeInterface) => void, rewrite?: boolean): void;
  /**
   * DOM改变触发
   *
   * @param eventType
   * @param ops
   */
  on(eventType: 'ops', listener: (ops: Op[]) => void, rewrite?: boolean): void;
  /**
   * 移除绑定事件
   *
   * @param eventType 事件类型
   ...
   * @param source 粘贴的富文本
   */
  trigger(eventType: 'paste:event', data: ClipboardData & { isPasteText: boolean }, source: string): boolean | void;
  /**
   * 设置本次粘贴所需保留标签的白名单，以及属性
   *
   * @param schema 标签白名单管理实例
   ...
   * @param rewrite
   */
  on(eventType: 'keydown:enter', listener: (event: KeyboardEvent) => boolean | void, rewrite?: boolean): void;
  /**
   ...
   * @param rewrite
   */
  on(eventType: 'keydown:backspace', listener: (event: KeyboardEvent) => boolean | void, rewrite?: boolean): void;
  /**
   ...
   * @param rewrite
   */
  on(eventType: 'keydown:tab', listener: (event: KeyboardEvent) => boolean | void, rewrite?: boolean): void;
  /**
   ...
   * @param rewrite
   */
  on(eventType: 'keydown:shift-tab', listener: (event: KeyboardEvent) => boolean | void, rewrite?: boolean): void;
  /**
   ...
   * @param rewrite
   */
  on(eventType: 'keydown:at', listener: (event: KeyboardEvent) => boolean | void, rewrite?: boolean): void;
  /**
   ...
   * @param rewrite
   */
  on(eventType: 'keydown:space', listener: (event: KeyboardEvent) => boolean | void, rewrite?: boolean): void;
  /**
   ...
   * @param rewrite
   */
  on(eventType: 'keydown:slash', listener: (event: KeyboardEvent) => boolean | void, rewrite?: boolean): void;
  /**
   ...
   * @param rewrite
   */
  on(eventType: 'keydown:left', listener: (event: KeyboardEvent) => boolean | void, rewrite?: boolean): void;
  /**
   ...
   * @param rewrite
   */
  on(eventType: 'keydown:right', listener: (event: KeyboardEvent) => boolean | void, rewrite?: boolean): void;
  /**
   ...
   * @param rewrite
   */
  on(eventType: 'keydown:up', listener: (event: KeyboardEvent) => boolean | void, rewrite?: boolean): void;
  /**
   ...
   * @param rewrite
   */
  on(eventType: 'keydown:down', listener: (event: KeyboardEvent) => boolean | void, rewrite?: boolean): void;
  /**
   ...
   * @param rewrite
   */
  on(eventType: 'keyup:enter', listener: (event: KeyboardEvent) => boolean | void, rewrite?: boolean): void;
  /**
   ...
   * @param rewrite
   */
  on(eventType: 'keyup:backspace', listener: (event: KeyboardEvent) => boolean | void, rewrite?: boolean): void;
  /**
   ...
   * @param rewrite
   */
  on(eventType: 'keyup:tab', listener: (event: KeyboardEvent) => boolean | void, rewrite?: boolean): void;
  /**
   ...
   * @param rewrite
   */
  on(eventType: 'keyup:space', listener: (event: KeyboardEvent) => boolean | void, rewrite?: boolean): void;
  /**
   * 编辑器光标选择变化时触发
   *
   * @param eventType
   ...
   * @param rewrite
   */
  on(eventType: 'realtimeChange', listener: (trigger: 'remote' | 'local') => void, rewrite?: boolean): void;
  /**
   * 设置编辑器值之前
   *
   * @param eventType
   ...
   * @param rewrite
   */
  on(eventType: 'beforeSetValue', listener: (value: string) => void, rewrite?: boolean): void;
  /**
   * 设置编辑器值之后
   *
   * @param eventType
   ...
   * @param rewrite
   */
  on(eventType: 'afterSetValue', listener: () => void, rewrite?: boolean): void;
  /**
   * 编辑器聚焦
   *
   * @param eventType
   ...
   * @param rewrite
   */
  on(eventType: 'readonly', listener: (readonly: boolean) => void, rewrite?: boolean): void;
  /**
   * 执行命令之前
   *
   * @param eventType
   ...
   * @param rewrite
   */
  on(eventType: 'beforeCommandExecute', listener: (name: string, ...args: any) => void, rewrite?: boolean): void;
  /**
   * 执行命令之后
   *
   * @param eventType
   ...
   * @param rewrite
   */
  on(eventType: 'afterCommandExecute', listener: (name: string, ...args: any) => void, rewrite?: boolean): void;
  /**
   * 拖动文件到编辑器时触发
   *
   * @param files 文件集合
   */
  on(eventType: 'drop:files', listener: (files: Array<File>) => void, rewrite?: boolean): void;
  /**
   * 历史撤销
   *
   * @param eventType
   ...
   * @param rewrite
   */
  on(eventType: 'undo', listener: () => boolean | void, rewrite?: boolean): void;
  /**
   * 历史重做
   *
   * @param eventType
   ...
   * @param rewrite
   */
  on(eventType: 'redo', listener: () => boolean | void, rewrite?: boolean): void;
  /**
   * 回车键按下，返回false，终止处理其它监听
   *
   * @param eventType
