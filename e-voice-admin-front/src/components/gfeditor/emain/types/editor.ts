import type { ListModelInterface } from './list';
...
export interface EditorOptions {
  ...
  /** 插件选项，每个插件具体选项请在插件查看 */
  config?: Record<string, PluginOptions> | ((editor: EditorInterface) => Record<string, PluginOptions>);
  ...
  lazyRender?: boolean;
  /**
   * 字体图标链接 默认： url('//at.alicdn.com/t/font_1456030_lnqmc6a6ca.woff2?t=1638071536645') format('woff2'),
