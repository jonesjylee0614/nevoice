...
import type { SelectionInterface } from './selection';

export interface Range {
  prototype: RangeInterface;
  new (): RangeInterface;
  /** 从一个 Point 位置获取 RangeInterface 对象 */
  create: (editor: EditorInterface, doc?: Document, point?: { x: number; y: number }) => RangeInterface;
  /** 从 Window 、Selection、Range 中创建 RangeInterface 对象 */
  from: (editor: EditorInterface, win?: Window | globalThis.Selection | globalThis.Range) => RangeInterface | null;
  /**
   * 从路径转换为光标
   *
   * @param path
   ...
   */
  fromPath(path: Path[], context?: NodeInterface, includeCardCursor?: boolean, root?: NodeInterface): RangeInterface;
}
...
export interface RangeInterface {
   ...
   */
  getSubRanges(includeCard?: boolean, filterSingleSelectableCard?: boolean): Array<RangeInterface>;
  /**
   ...
   * @param root 根节点，默认编辑器根节点
   */
  toPath(includeCardCursor?: boolean, root?: NodeInterface): { start: RangePath; end: RangePath } | undefined;
}
