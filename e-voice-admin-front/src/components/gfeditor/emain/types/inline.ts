...
export interface InlineModelInterface {
   ...
   * @param node
   */
  flat(node: NodeInterface | RangeInterface, schema?: SchemaInterface): void | NodeInterface;
}

export interface InlineInterface<T extends PluginOptions = PluginOptions> extends ElementPluginInterface<T> {
