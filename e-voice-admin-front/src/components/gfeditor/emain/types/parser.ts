import type { ConversionInterface } from './conversion';
...
export interface ParserInterface {
  ...
  /** 返回DOM树 */
  toDOM(schema?: SchemaInterface | null, conversion?: ConversionInterface | null): DocumentFragment;
   ...
   */
  toText(schema?: SchemaInterface, includeCard?: boolean, formatOL?: boolean): string;
}
