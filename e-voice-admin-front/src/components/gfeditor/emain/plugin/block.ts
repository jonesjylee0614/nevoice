import type { BlockInterface, PluginInterface, PluginOptions, SchemaBlock } from '../types';
...
export const isBlockPlugin = (plugin: PluginInterface): plugin is BlockInterface => {
