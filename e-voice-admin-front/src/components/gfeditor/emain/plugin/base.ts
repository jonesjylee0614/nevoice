...
import type { PluginInterface, PluginOptions } from '../types/plugin';

abstract class PluginEntry<T extends PluginOptions = PluginOptions> implements PluginInterface<T> {
