import type { CardInterface, EditorInterface, MaximizeInterface, NodeInterface } from '../../types';
import { $ } from '../../node';
...
class Maximize implements MaximizeInterface {
  ...
  maximize() {
    ...
    const node = $(`<div class="card-maximize-header" ${DATA_TRANSIENT_ELEMENT}="true" ${DATA_ELEMENT}="${UI}">
