...
import { CARD_CENTER_SELECTOR, CARD_LEFT_SELECTOR, CARD_RIGHT_SELECTOR } from '../../constants';
import type { CardEntry, CardInterface, EngineInterface, RangeInterface } from '../../types';
...
class Left {
  ...
  trigger(event: KeyboardEvent) {
    ...
    return card.type === CardType.INLINE ? this.inline(card, event) : this.block(card, event);
  }
}
export default Left;
