export default {
  'login.form.title': 'Login management system',
  'login.form.subtitle': 'Manage application data, usage operations, account management',
  ...
  'login.form.verification.placeholder': 'verification',
