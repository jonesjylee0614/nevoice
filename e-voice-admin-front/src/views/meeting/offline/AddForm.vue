          ...
          <div class="content_box">
            ...
            <AScrollbar style="overflow: auto" :style="{ height: `${windHeight}px` }">
              <div class="besecontent">
                <AFormItem field="name" label="会议名" required>
                  <AInput v-model="formData.name" placeholder="请填会议名" />
                </AFormItem>
                <AFormItem field="meetingTime" label="会议时间" required>
                  <ADatePicker v-model="formData.meetingTime" show-time :disabled="isUpdate" />
                </AFormItem>
                <AFormItem field="audio" label="会议音频">
                  <AudioUpload ref="audioUploadRef" :params="formData" :disabled="isUpdate" />
                </AFormItem>
              </div>
            </AScrollbar>
          </div>
...
import AudioUpload from '@/views/meeting/offline/AudioUpload.vue';
import { update } from '@/views/meeting/offline/api';
