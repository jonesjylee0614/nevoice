      ...
      <div class="studio-bar">
        <div v-if="userInfo">
          <ASpace :size="12">
            ...
            <ATypographyText>{{ userInfo.name }} {{ $t('monitor.studioPreview.studio') }}</ATypographyText>
          </ASpace>
        </div>
        <ATypographyText type="secondary">36,000 {{ $t('monitor.studioPreview.watching') }}</ATypographyText>
      </div>
    </div>
  </ACard>
</template>
