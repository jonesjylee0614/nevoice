...
// 代码仓库登录
const cstoreIsLogin = () => {
  return Boolean(localStorage.getItem(CODESTORE_TOKEN_KEY));
};
...
export { isLogin, getToken, setToken, clearToken, cstoreIsLogin, getCstoreToken, setCstoreToken, clearCstoreToken };
