...
## 4. WebSocket 实时识别（单版本）

### 4.1 握手（v1/v2）

- URL：`wss://<your-domain>/ws/recognize?x-ak=...&x-t=...&x-sign=...`
- 子协议：`binary`
- 流程：连接建立 → 客户端发送配置消息 → 推送音频帧 → 离线纠错（2pass）补丁。
...
```json
{
  ...
  "revision": 7,
  "text": "各位同事大家好",
  "segment_id": "seg-sess-0007",
  "session_id": "sess-3f8a",
  "request_id": "req-79fe",
  "timestamps": {"event_ms": 1735230123456},
  "text_state": {
    "confirmed_text": "各位同事，",
    "candidate_text": "大家",
    "revision_id": 12
  },
  "meta": {"language": "zh-CN", "unstable_rate": 0.12}
}
```
...
```json
{
  ...
  "revision": 13,
  "text": "各位同事，大家好。",
  "sentences": [{"text": "各位同事，大家好。", "start_ms": 0, "end_ms": 2100}],
  "is_final": true,
  "segment_id": "seg-sess-0007",
  "session_id": "sess-3f8a",
  "request_id": "req-79fe",
