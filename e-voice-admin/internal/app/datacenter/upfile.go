...
func init() {
	gf.RegisterRoute(&Upfile{})
}

// UploadFile 上传图片 /datacenter/upfile/uploadFile
func (s *Upfile) UploadFile(c *gin.Context) {
	// 单个文件
...
func (s *Upfile) Perms() map[string][]gin.HandlerFunc {
	return map[string][]gin.HandlerFunc{
		"atta:base": {s.UploadFile},
	}
}
