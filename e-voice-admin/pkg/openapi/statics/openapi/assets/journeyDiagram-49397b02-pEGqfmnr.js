...
`,P=ne,F=function(e,t){return h(e,t)},I=function(t,n){let r=15,i=t.append(`circle`).attr(`cx`,n.cx).attr(`cy`,n.cy).attr(`class`,`face`).attr(`r`,r).attr(`stroke-width`,2).attr(`overflow`,`visible`),a=t.append(`g`);a.append(`circle`).attr(`cx`,n.cx-r/3).attr(`cy`,n.cy-r/3).attr(`r`,1.5).attr(`stroke-width`,2).attr(`fill`,`#666`).attr(`stroke`,`#666`),a.append(`circle`).attr(`cx`,n.cx+r/3).attr(`cy`,n.cy-r/3).attr(`r`,1.5).attr(`stroke-width`,2).attr(`fill`,`#666`).attr(`stroke`,`#666`);function o(t){let i=e().startAngle(Math.PI/2).endAngle(3*(Math.PI/2)).innerRadius(r/2).outerRadius(r/2.2);t.append(`path`).attr(`class`,`mouth`).attr(`d`,i).attr(`transform`,`translate(`+n.cx+`,`+(n.cy+2)+`)`)}function s(t){let i=e().startAngle(3*Math.PI/2).endAngle(5*(Math.PI/2)).innerRadius(r/2).outerRadius(r/2.2);t.append(`path`).attr(`class`,`mouth`).attr(`d`,i).attr(`transform`,`translate(`+n.cx+`,`+(n.cy+7)+`)`)}function c(e){e.append(`line`).attr(`class`,`mouth`).attr(`stroke`,2).attr(`x1`,n.cx-5).attr(`y1`,n.cy+7).attr(`x2`,n.cx+5).attr(`y2`,n.cy+7).attr(`class`,`mouth`).attr(`stroke-width`,`1px`).attr(`stroke`,`#666`)}return n.score>3?o(a):n.score<3?s(a):c(a),i},L=function(e,t){let n=e.append(`circle`);return n.attr(`cx`,t.cx),n.attr(`cy`,t.cy),n.attr(`class`,`actor-`+t.pos),n.attr(`fill`,t.fill),n.attr(`stroke`,t.stroke),n.attr(`r`,t.r),n.class!==void 0&&n.attr(`class`,n.class),t.title!==void 0&&n.append(`title`).text(t.title),n},R=function(e,t){return g(e,t)},re=function(e,t){function n(e,t,n,r,i){return e+`,`+t+` `+(e+n)+`,`+t+` `+(e+n)+`,`+(t+r-i)+` `+(e+n-i*1.2)+`,`+(t+r)+` `+e+`,`+(t+r)}let r=e.append(`polygon`);r.attr(`points`,n(t.x,t.y,50,20,7)),r.attr(`class`,`labelBox`),t.y+=t.labelMargin,t.x+=.5*t.labelMargin,R(e,t)},ie=function(e,t,n){let r=e.append(`g`),i=_();i.x=t.x,i.y=t.y,i.fill=t.fill,i.width=n.width*t.taskCount+n.diagramMarginX*(t.taskCount-1),i.height=n.height,i.class=`journey-section section-type-`+t.num,i.rx=3,i.ry=3,F(r,i),H(n)(t.text,r,i.x,i.y,i.width,i.height,{class:`journey-section section-type-`+t.num},n,t.colour)};let z=-1;const B=function(e,t,n){let r=t.x+n.width/2,i=e.append(`g`);z++;let a=450;i.append(`line`).attr(`id`,`task`+z).attr(`x1`,r).attr(`y1`,t.y).attr(`x2`,r).attr(`y2`,a).attr(`class`,`task-line`).attr(`stroke-width`,`1px`).attr(`stroke-dasharray`,`4 2`).attr(`stroke`,`#666`),I(i,{cx:r,cy:300+(5-t.score)*30,score:t.score});let o=_();o.x=t.x,o.y=t.y,o.fill=t.fill,o.width=n.width,o.height=n.height,o.class=`task task-type-`+t.num,o.rx=3,o.ry=3,F(i,o);let s=t.x+14;t.people.forEach(e=>{let n=t.actors[e].color,r={cx:s,cy:t.y,r:7,fill:n,stroke:`#000`,title:e,pos:t.actors[e].position};L(i,r),s+=10}),H(n)(t.task,i,o.x,o.y,o.width,o.height,{class:`task`},n,t.colour)},V=function(e,t){m(e,t)},H=function(){function e(e,t,n,i,a,o,s,c){let l=t.append(`text`).attr(`x`,n+a/2).attr(`y`,i+o/2+5).style(`font-color`,c).style(`text-anchor`,`middle`).text(e);r(l,s)}function t(e,t,n,i,a,o,s,c,l){let{taskFontSize:u,taskFontFamily:d}=c,f=e.split(/<br\s*\/?>/gi);for(let e=0;e<f.length;e++){let c=e*u-u*(f.length-1)/2,p=t.append(`text`).attr(`x`,n+a/2).attr(`y`,i).attr(`fill`,l).style(`text-anchor`,`middle`).style(`font-size`,u).style(`font-family`,d);p.append(`tspan`).attr(`x`,n+a/2).attr(`dy`,c).text(f[e]),p.attr(`y`,i+o/2).attr(`dominant-baseline`,`central`).attr(`alignment-baseline`,`central`),r(p,s)}}function n(e,n,i,a,o,s,c,l){let u=n.append(`switch`),d=u.append(`foreignObject`).attr(`x`,i).attr(`y`,a).attr(`width`,o).attr(`height`,s).attr(`position`,`fixed`),f=d.append(`xhtml:div`).style(`display`,`table`).style(`height`,`100%`).style(`width`,`100%`);f.append(`div`).attr(`class`,`label`).style(`display`,`table-cell`).style(`text-align`,`center`).style(`vertical-align`,`middle`).text(e),t(e,u,i,a,o,s,c,l),r(f,c)}function r(e,t){for(let n in t)n in t&&e.attr(n,t[n])}return function(r){return r.textPlacement===`fo`?n:r.textPlacement===`old`?e:t}}(),U=function(e){e.append(`defs`).append(`marker`).attr(`id`,`arrowhead`).attr(`refX`,5).attr(`refY`,2).attr(`markerWidth`,6).attr(`markerHeight`,4).attr(`orient`,`auto`).append(`path`).attr(`d`,`M 0,0 V 4 L6,2 Z`)},W={drawRect:F,drawCircle:L,drawSection:ie,drawText:R,drawLabel:re,drawTask:B,drawBackgroundRect:V,initGraphics:U},G=function(e){let t=Object.keys(e);t.forEach(function(t){J[t]=e[t]})},K={};function q(e){let t=o().journey,n=60;Object.keys(K).forEach(r=>{let i=K[r].color,a={cx:20,cy:n,r:7,fill:i,stroke:`#000`,pos:K[r].position};W.drawCircle(e,a);let o={x:40,y:n+7,fill:`#666`,text:r,textMargin:t.boxTextMargin|5};W.drawText(e,o),n+=20})}const J=o().journey,Y=J.leftMargin,ae=function(e,t,n,i){let a=o().journey,s=o().securityLevel,c;s===`sandbox`&&(c=u(`#i`+t));let l=u(s===`sandbox`?c.nodes()[0].contentDocument.body:`body`);X.init();let d=l.select(`#`+t);W.initGraphics(d);let f=i.db.getTasks(),p=i.db.getDiagramTitle(),m=i.db.getActors();for(let e in K)delete K[e];let h=0;m.forEach(e=>{K[e]={color:a.actorColours[h%a.actorColours.length],position:h},h++}),q(d),X.insert(0,0,Y,Object.keys(K).length*50),oe(d,f,0);let g=X.getBounds();p&&d.append(`text`).text(p).attr(`x`,Y).attr(`font-size`,`4ex`).attr(`font-weight`,`bold`).attr(`y`,25);let _=g.stopy-g.starty+2*a.diagramMarginY,v=Y+g.stopx+2*a.diagramMarginX;r(d,_,v,a.useMaxWidth),d.append(`line`).attr(`x1`,Y).attr(`y1`,a.height*4).attr(`x2`,v-Y-4).attr(`y2`,a.height*4).attr(`stroke-width`,4).attr(`stroke`,`black`).attr(`marker-end`,`url(#arrowhead)`);let y=p?70:0;d.attr(`viewBox`,`${g.startx} -25 ${v} ${_+y}`),d.attr(`preserveAspectRatio`,`xMinYMin meet`),d.attr(`height`,_+y+25)},X={data:{startx:void 0,stopx:void 0,starty:void 0,stopy:void 0},verticalPos:0,sequenceItems:[],init:function(){this.sequenceItems=[],this.data={startx:void 0,stopx:void 0,starty:void 0,stopy:void 0},this.verticalPos=0},updateVal:function(e,t,n,r){e[t]===void 0?e[t]=n:e[t]=r(n,e[t])},updateBounds:function(e,t,n,r){let i=o().journey,a=this,s=0;function c(o){return function(c){s++;let l=a.sequenceItems.length-s+1;a.updateVal(c,`starty`,t-l*i.boxMargin,Math.min),a.updateVal(c,`stopy`,r+l*i.boxMargin,Math.max),a.updateVal(X.data,`startx`,e-l*i.boxMargin,Math.min),a.updateVal(X.data,`stopx`,n+l*i.boxMargin,Math.max),o!==`activation`&&(a.updateVal(c,`startx`,e-l*i.boxMargin,Math.min),a.updateVal(c,`stopx`,n+l*i.boxMargin,Math.max),a.updateVal(X.data,`starty`,t-l*i.boxMargin,Math.min),a.updateVal(X.data,`stopy`,r+l*i.boxMargin,Math.max))}}this.sequenceItems.forEach(c())},insert:function(e,t,n,r){let i=Math.min(e,n),a=Math.max(e,n),o=Math.min(t,r),s=Math.max(t,r);this.updateVal(X.data,`startx`,i,Math.min),this.updateVal(X.data,`starty`,o,Math.min),this.updateVal(X.data,`stopx`,a,Math.max),this.updateVal(X.data,`stopy`,s,Math.max),this.updateBounds(i,o,a,s)},bumpVerticalPos:function(e){this.verticalPos+=e,this.data.stopy=this.verticalPos},getVerticalPos:function(){return this.verticalPos},getBounds:function(){return this.data}},Z=J.sectionFills,Q=J.sectionColours,oe=function(e,t,n){let r=o().journey,i=``,a=r.height*2+r.diagramMarginY,s=n+a,c=0,l=`#CCC`,u=`black`,d=0;for(let[n,a]of t.entries()){if(i!==a.section){l=Z[c%Z.length],d=c%Z.length,u=Q[c%Q.length];let o=0,s=a.section;for(let e=n;e<t.length&&t[e].section==s;e++)o+=1;let f={x:n*r.taskMargin+n*r.width+Y,y:50,text:a.section,fill:l,num:d,colour:u,taskCount:o};W.drawSection(e,f,r),i=a.section,c++}let o=a.people.reduce((e,t)=>(K[t]&&(e[t]=K[t]),e),{});a.x=n*r.taskMargin+n*r.width+Y,a.y=s,a.width=r.diagramMarginX,a.height=r.diagramMarginY,a.colour=u,a.fill=l,a.num=d,a.actors=o,W.drawTask(e,a,r),X.insert(a.x,a.y,a.x+a.width+r.taskMargin,450)}},$={setConf:G,draw:ae},se={parser:x,db:N,renderer:$,styles:P,init:e=>{$.setConf(e.journey),N.clear()}};export{se as diagram};