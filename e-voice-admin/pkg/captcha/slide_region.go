...
func (s *Service) getSlideRegionData(ctx context.Context) *GetRes {
	captData, _ := slideRegionCapt.Generate()
...
func (s *Service) checkSlideRegion(ctx context.Context, f *Check) bool {
