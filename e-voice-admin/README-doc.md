...
需要其他扩展功能如：定时任务、cms、websocket、mqtt，数据大屏，微信管理、抖音小程序快速开发、OA流程审批、工作流引擎等插件请移步到企业版使用，企业版是一个众人参与，每个开发者都可以把自己编写的代码打包上传代码仓，代码仓大家可以一同使用，[更多插件可到代码市场查看](https://goflys.cn/codemarket)。 **:tw-1f493: 框架存在的意义是让开发变得简单，而不是让开发变得复杂**
## 二、预览(演示)地址
[GoFly全栈开发社区](https://goflys.cn)
...
[4.未安装插件-业务开发的business端在线体验-保持最新版本](https://spl.goflys.cn/webbusiness/)
...
```
9. 框架以“大道至简，唯快不破”为思想，在每个细节处理都坚持让“开发”变得简单，即使你是新手也可以跟着开发文档快手上手并能开发出企业级产品，因为简单代码可读性高、可维护性更好，这样项目交接新人可快速接手。
...
```
如果你想要手动安装前端代码，源码在代码包的resource/developer/template/vuecode目录下文件夹中，自己复制到开发文件夹下即可。
